...
int main() {
    ...
    many {
        ll n;
        cin >> n;
        auto a = integer_factorization_3::shankss_square_forms_factorization(n);
        if (a.size() >= 3) {
            cout << "YES\n";
            ll t1 = a[0].first, t2 = a[1].first, t3 = n / t1 / t2;
            ou(t1, t2, t3);
        } else if (a.size() == 2) {
            ...
            if (a[0].second >= 3) {
                cout << "YES\n";
                ll t1 = a[0].first;
                ll t2 = a[0].first * a[0].first;
                ll t3 = n / t1 / t2;
                ou(t1, t2, t3);
            } else if (a[0].second == 2 && a[1].second == 2) {
                cout << "YES\n";
                ll t1 = a[0].first, t2 = a[1].first;
                ll t3 = n / t1 / t2;
                ou(t1, t2, t3);
            } else {
                cout << "NO\n";
