...
int main() {
    ...
    if (ll(a) + b + c >= 3)
        ...
        auto f = vect<int>({}, n + 1, 3, 3, 3);
        auto g = vect<pair<char, vi>>({}, n + 1, 3, 3, 3);
        f[0][a][b][c] = 1;
        lp(i, 0, n - 1) {
            str o;
            in(o);
            lp(na, 0, 2) lp(nb, 0, 2) lp(nc, 0, 2) {
                if (f[i][na][nb][nc]) {
                    if (o == "AB") {
                        if (na) {
                            f[i + 1][na - 1][nb + 1][nc] = 1;
                            g[i + 1][na - 1][nb + 1][nc] = {'B', {na, nb, nc}};
                        }
                        if (nb) {
                            f[i + 1][na + 1][nb - 1][nc] = 1;
                            g[i + 1][na + 1][nb - 1][nc] = {'A', {na, nb, nc}};
                        }
                    }
                    if (o == "AC") {
                        if (na) {
                            f[i + 1][na - 1][nb][nc + 1] = 1;
                            g[i + 1][na - 1][nb][nc + 1] = {'C', {na, nb, nc}};
                        }
                        if (nc) {
                            f[i + 1][na + 1][nb][nc - 1] = 1;
                            g[i + 1][na + 1][nb][nc - 1] = {'A', {na, nb, nc}};
                        }
                    }
                    if (o == "BC") {
                        if (nb) {
                            f[i + 1][na][nb - 1][nc + 1] = 1;
                            g[i + 1][na][nb - 1][nc + 1] = {'C', {na, nb, nc}};
                        }
                        if (nc) {
                            f[i + 1][na][nb + 1][nc - 1] = 1;
                            g[i + 1][na][nb + 1][nc - 1] = {'B', {na, nb, nc}};
                        }
                    }
                }
            }
        ...
        int ta = -1, tb, tc;
        lp(na, 0, 2) lp(nb, 0, 2) lp(nc, 0, 2) if (f[n][na][nb][nc]) ta = na,
                                                                     tb = nb,
                                                                     tc = nc;
        if (ta < 0)
            fail = 1;
            ...
            while (n) {
                ...
                ta = t.second[0], tb = t.second[1], tc = t.second[2];
                --n;
            }
            reve(ans);
        }
